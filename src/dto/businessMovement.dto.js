...
export const createBusinessMovementSchema = z.object({
  ...
  Reason: z.enum(['SALE', 'PURCHASE', 'ADJUSTMENT', 'LOSS', 'PROMOTION_SALE'], {
    errorMap: () => ({ message: 'Reason debe ser SALE, PURCHASE, ADJUSTMENT, LOSS o PROMOTION_SALE' })
  }),
...
export const updateBusinessMovementSchema = z.object({
  ...
  Reason: z.enum(['SALE', 'PURCHASE', 'ADJUSTMENT', 'LOSS', 'PROMOTION_SALE']).optional(),
